...
public class TrelloObjectFactoryImplTest {
    ...
    public void shouldCreateBoardList() throws Exception {
        ...
        // WHEN
        List<Board> boards = trelloObjFactory.createObject(new TypeToken<List<Board>>() {
        }, json);
    ...
    public void shouldCreateBoard() throws Exception {
        ...
        // WHEN
        Board board = trelloObjFactory.createObject(new TypeToken<Board>() {
        }, json);
    ...
    public void shouldCreateChecklist() throws Exception {
        ...
        // WHEN
        CheckList checklist = trelloObjFactory.createObject(new TypeToken<CheckList>() {
        }, json);
        ...
        CheckItem firstCheckItem = checklist.getCheckItems().get(0);
    ...
    public void shouldCreateType() throws Exception {
        ...
        // WHEN
        Type type = trelloObjFactory.createObject(new TypeToken<Type>() {
        }, json);
