...
public class TrelloImpl implements Trello {
    ...
    public CheckItem postCheckItem(String checkListId, CheckItem item) {
        ...
        final String url = TrelloURL
                .create(apiKey, TrelloURL.CHECKITEM_POST_URL, checkListId)
                .token(token)
                .build();
    ...
    public void deleteCheckItem(String checkListId, String checkItemId) {
        validateObjectId(checkListId);
        validateObjectId(checkItemId);

        final String url = TrelloURL
                .create(apiKey, TrelloURL.CHECKITEM_DELETE_URL, checkListId, checkItemId)
                .token(token)
                .build();
